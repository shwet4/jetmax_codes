...
TAG_SIZE = 33.30
TARGET_POSITIONS = (((235, -66, 85), -18), ((235, -66, 125), -18), ((235, -66, 173), -18))
...
def moving():
    try:
        ...
        jetmax.set_position((nn_new_x, new_y, 120), t)
        rospy.sleep(t + 0.1)
        jetmax.set_position((new_x, new_y, 120), 0.3)
        rospy.sleep(0.4)

        sucker.set_state(True)
        jetmax.set_position((new_x, new_y, 85 - 5), 1)
        rospy.sleep(1)

        cur_x, cur_y, cur_z = jetmax.position
        (x, y, z), angle = TARGET_POSITIONS[state.level]
        jetmax.set_position((cur_x, cur_y, 200 + 4), 0.8)
        rospy.sleep(0.8)
        ...
        jetmax.set_position((x, y + 10, 200), t)
        rospy.sleep(t)
        jetmax.set_position((x, y, 200), 0.3)
        rospy.sleep(0.4)
