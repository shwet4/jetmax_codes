...
TARGET_POSITIONS = {
    'recyclable_waste': (163, -59, 65, 65),
    'hazardous_waste': (163, -6, 65, 85),
    'food_waste': (163, -6 + 52, 65, 100),
    'residual_waste': (163, -6 + 52 * 2, 65, 118)
}
...
def moving():
    try:
        ...
        jetmax.set_position((new_x, new_y, 50 - 4), 0.8)
        rospy.sleep(0.85)

        x, y, z, angle = TARGET_POSITIONS[waste_class_name]
        cur_x, cur_y, cur_z = jetmax.position
        ...
        rospy.sleep(t)
        jetmax.set_position((x, y, 120), 0.3)
        rospy.sleep(0.4)
