...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'color_palletizing' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hiwonder/ros/src/jetmax_buildin_funcs/color_palletizing/${idir}'.  ${_report}")
    endif()
